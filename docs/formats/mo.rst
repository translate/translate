...
.. versionchanged:: 1.2
   ...
   should be functionally equivalent and 100% usable. `Bug 326
   <http://bugs.locamotion.org/show_bug.cgi?id=326>`_ tracked the
   implementation of the hashing. The hash is platform dependent.
