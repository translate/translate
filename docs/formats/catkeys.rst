...
Localisation for the `Haiku <https://www.haiku-os.org/>`_ operating system is
...
* `Some notes about the format
  <https://www.haiku-os.org/blog/pulkomandy/2009-09-24_haiku_locale_kit_translator_handbook>`_
* `Some example files
  <https://cgit.haiku-os.org/haiku/tree/data/catalogs/>`_
