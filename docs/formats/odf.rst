...
OpenDocument Format
*******************
This page summarises the support for the `OpenDocument format <http://en.wikipedia.org/wiki/OpenDocument>`_ (ODF) in the Translate Toolkit. This currently involves only the :doc:`odf2xliff </commands/odf2xliff>` and xliff2odf converters.
...
* `Currently used and classified tags <https://github.com/translate/translate/blob/master/translate/storage/odf_shared.py#L23>`_
