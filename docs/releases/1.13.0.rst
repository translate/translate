...
upcoming `Pootle <https://pootle.translatehouse.org/>`_ 2.6.0 and 2.7.0 and
`Virtaal <https://virtaal.translatehouse.org>`_ releases.
...
..
  ...
  * Please share this URL https://toolkit.translatehouse.org/download.html if
...
- Expanded printf quality check to support reordering `boost::format
  <https://www.boost.org/doc/libs/1_55_0/libs/format/doc/format.html>`_
