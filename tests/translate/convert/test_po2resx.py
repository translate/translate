...
[Translator Comment: This is an existing translator comment : 22.12.14]</comment>
    ...
    def test_unescaped_plus_in_resourcekey(self) -> None:
        """Tests that resource keys with + characters are handled correctly."""
        po_source = r'''#: DLG_WORKFLOW+101
...
msgstr "Translated Workflow Dialog"'''
    ...
    def test_multiple_special_chars_in_resourcekey(self) -> None:
        """Tests resource keys with various special characters are preserved."""
        po_source = r'''#: Button+OK
msgid "OK"
msgstr "Oké"
