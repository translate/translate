...
class TestOO2PO:
    ...
    def check_roundtrip(self, filename, text) -> None:
    ...
    def test_roundtrip_whitespaceonly(self) -> None:
    ...
    def test_double_escapes(self) -> None:
    ...
    def test_escapes_helpcontent2(self) -> None:
    ...
    def test_x_comment_inclusion(self) -> None:
