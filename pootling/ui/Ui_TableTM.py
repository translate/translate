...
#
# Created: Thu May 10 14:43:56 2007
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(QtCore.QSize(QtCore.QRect(0,0,192,151).size()).expandedTo(Form.minimumSizeHint()))
        ...
        self.gridlayout.addWidget(self.tblTM,0,0,1,2)
        ...
        self.gridlayout.addWidget(self.lblDate,4,1,1,1)
