...
#
# Created: Fri Mar 23 14:22:15 2007
...
class Ui_tmsetting(object):
    def setupUi(self, tmsetting):
        ...
        tmsetting.resize(QtCore.QSize(QtCore.QRect(0,0,455,373).size()).expandedTo(tmsetting.minimumSizeHint()))
        ...
        self.gridlayout.addWidget(self.btnOk,9,1,1,1)
        ...
        self.gridlayout.addWidget(self.btnCancel,9,2,1,1)
        ...
        spacerItem = QtGui.QSpacerItem(31,16,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, tmsetting):
        ...
        self.checkBox.setWhatsThis(QtGui.QApplication.translate("tmsetting", "<h3>Dive into subfolders</h3>If it is checked the process will include subfolders for translation memory scaning.", None, QtGui.QApplication.UnicodeUTF8))
