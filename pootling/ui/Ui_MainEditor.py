...
#
# Created: Fri Jun 15 17:03:57 2007
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Open</h3>You will be asked for the name of a file to be opened and open recent file in an editor window.", None, QtGui.QApplication.UnicodeUTF8))
        self.actionOpen.setShortcut(QtGui.QApplication.translate("MainWindow", "Ctrl+O", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave.setText(QtGui.QApplication.translate("MainWindow", "&Save", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave.setStatusTip(QtGui.QApplication.translate("MainWindow", "Save a file", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionSaveas.setStatusTip(QtGui.QApplication.translate("MainWindow", "Save File As", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSaveas.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Save File As</h3> Save the contents of the current editor to a new file. The file can be entered in a file selection dialog.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionExit.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Quit the application</h3>This quits the application. Any unsaved changes may be saved first.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionCut.setStatusTip(QtGui.QApplication.translate("MainWindow", "Cut the selection", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionCopy.setStatusTip(QtGui.QApplication.translate("MainWindow", "Copy the selection", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFind.setStatusTip(QtGui.QApplication.translate("MainWindow", "Find for a text", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFind.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Find</h3>Search for some text in the table. The Find dialog will be shown at the bottom of editor to enter searchtext and options.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFirst.setStatusTip(QtGui.QApplication.translate("MainWindow", "Go to first unit", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionPrevious.setStatusTip(QtGui.QApplication.translate("MainWindow", "Go to previous unit", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionNext.setStatusTip(QtGui.QApplication.translate("MainWindow", "Go to next unit", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionLast.setStatusTip(QtGui.QApplication.translate("MainWindow", "Go to last unit", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionCopySource2Target.setStatusTip(QtGui.QApplication.translate("MainWindow", "Copy source to target", None, QtGui.QApplication.UnicodeUTF8))
        self.actionCopySource2Target.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Copy source to target</h3>It will copy current unit\'s source to current unit\'s target.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionToggleFuzzy.setStatusTip(QtGui.QApplication.translate("MainWindow", "Toggle current unit\'s fuzzy status", None, QtGui.QApplication.UnicodeUTF8))
        self.actionToggleFuzzy.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Toggle current unit\'s fuzzy status</h3>If current unit is fuzzy, then set to it unfuzzy. If it is unfuzzy, then set it to fuzzy.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionReplace.setStatusTip(QtGui.QApplication.translate("MainWindow", "Replace some text", None, QtGui.QApplication.UnicodeUTF8))
        self.actionReplace.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Replace</h3>Search for some text in the table and replace it. A dialog is shown to enter the search text, the replacement text and options for the search and replace.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionEdit_Header.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Open header dialog</h3>Open the dialog to edit the header information.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionPreferences.setStatusTip(QtGui.QApplication.translate("MainWindow", "Set common options for personality, font/color, TM/Glosary, Save", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFilterFuzzy.setToolTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Fuzzy Strings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterFuzzy.setStatusTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Fuzzy Strings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterFuzzy.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Hide/Show Fuzzy Strings</h3>If Fuzzy Strings are hidden, then display them. If they are displayed, then hide string.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFilterTranslated.setToolTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Translated Strings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterTranslated.setStatusTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Translated Strings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterTranslated.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Hide/Show Translated Strings</h3>If Translated Strings are hidden, then display them. If they are displayed, then hide them.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFilterUntranslated.setToolTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Untranslated Strings", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterUntranslated.setStatusTip(QtGui.QApplication.translate("MainWindow", "Hide/Show Untranslated String", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterUntranslated.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Hide/Show Untranslated Strings</h3>If Untranslated String are hidden, then display them. If they are displayed, then hide String.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionGoTo.setText(QtGui.QApplication.translate("MainWindow", "&GoTo String", None, QtGui.QApplication.UnicodeUTF8))
        self.actionGoTo.setIconText(QtGui.QApplication.translate("MainWindow", "GoTo String", None, QtGui.QApplication.UnicodeUTF8))
        self.actionGoTo.setToolTip(QtGui.QApplication.translate("MainWindow", "GoTo String", None, QtGui.QApplication.UnicodeUTF8))
        self.actionGoTo.setStatusTip(QtGui.QApplication.translate("MainWindow", "Go to String", None, QtGui.QApplication.UnicodeUTF8))
        self.actionGoTo.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>GoTo String</h3>It will go to a string in the table, according to given index.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionAddBookmarks.setStatusTip(QtGui.QApplication.translate("MainWindow", "Add bookmark on current unit", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAddBookmarks.setWhatsThis(QtGui.QApplication.translate("MainWindow", "<h3>Add Bookmarks</h3> A mark on current unit will be added.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionCatalogManager.setStatusTip(QtGui.QApplication.translate("MainWindow", "Configure the Catalog Manager", None, QtGui.QApplication.UnicodeUTF8))
