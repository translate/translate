...
#
# Created: Fri Jun  1 09:20:53 2007
...
class Ui_StatisticsDialog(object):
    def setupUi(self, StatisticsDialog):
        ...
        StatisticsDialog.resize(QtCore.QSize(QtCore.QRect(0,0,260,227).size()).expandedTo(StatisticsDialog.minimumSizeHint()))
        ...
        spacerItem = QtGui.QSpacerItem(20,111,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout1.addItem(spacerItem,0,2,1,2)
        ...
        self.gridlayout1.addWidget(self.lblFuzzy,7,2,1,1)
        ...
        self.gridlayout1.addWidget(self.lblFuzzyPercent,7,3,1,1)
        ...
        self.gridlayout1.addWidget(self.lblNumberofFiles,3,2,1,1)
        ...
        self.gridlayout1.addWidget(self.lblTotal,11,2,1,1)
        ...
        self.gridlayout1.addWidget(self.label_5,11,0,1,1)
        ...
        self.gridlayout1.addWidget(self.label_4,9,0,1,2)
        ...
        self.gridlayout1.addWidget(self.label,3,0,1,2)
        ...
        spacerItem1 = QtGui.QSpacerItem(195,16,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout1.addItem(spacerItem1,12,0,1,4)
        ...
        self.gridlayout1.addWidget(self.lblUntranslated,9,2,1,1)
        ...
        self.gridlayout1.addWidget(self.lblUntranPercent,9,3,1,1)
        ...
        self.gridlayout1.addWidget(self.lblTotalPercent,11,3,1,1)

        self.lblStatistic = QtGui.QLabel(self.frame)
        self.lblStatistic.setFrameShape(QtGui.QFrame.NoFrame)
        self.lblStatistic.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lblStatistic.setObjectName("lblStatistic")
        self.gridlayout1.addWidget(self.lblStatistic,1,1,1,2)
        ...
        font = QtGui.QFont(self.lblStatistic1.font())
