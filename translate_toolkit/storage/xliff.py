...
from translate_toolkit.misc.xml_helpers import (
    clear_content,
    getXMLspace,
    setXMLlang,
    setXMLspace,
)
from translate_toolkit.storage import base, lisa
from translate_toolkit.storage.placeables.lisa import strelem_to_xml, xml_to_strelem
from translate_toolkit.storage.workflow import StateEnum as state
    ...
    def parsestring(cls, storestring):
        ...
        if xliff.units:
            ...
            if (
                ...
                from translate_toolkit.storage import poxliff
