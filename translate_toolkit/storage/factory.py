...
from translate_toolkit.storage.base import TranslationStore
from translate_toolkit.storage.directory import Directory
...
###  XXX:  if you add anything here, you must also add it to translate_toolkit.storage.
...
def _examine_txt(storefile):
    ...
    from translate_toolkit.storage import wordfast
...
def getclass(
    ...
    try:
        ...
        if classes:
            ...
            storeclass = import_class(*classes_str[ext], "translate_toolkit.storage")
    except KeyError:
