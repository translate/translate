...
from translate_toolkit.convert import factory as convert_factory
from translate_toolkit.storage.projstore import ProjectStore
...
class Project:
    ...
    def convert_forward(self, input_fname, template=None, output_fname=None, **options):
        ...
        :param convert_options: Passed as-is to
                                :meth:`translate_toolkit.convert.factory.convert`.
    ...
    def export_file(self, fname, destfname):
        ...
        :exc:`~translate_toolkit.storage.projstore.FileNotInProjectError` via the call
        to :meth:`~translate_toolkit.storage.projstore.ProjectStore.get_file` if
