...
from translate_toolkit.misc.xml_helpers import normalize_xml_space
from translate_toolkit.storage.placeables import StringElem, base, xliff
from translate_toolkit.storage.xml_extract import misc
