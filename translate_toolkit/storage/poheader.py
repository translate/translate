...
from translate_toolkit import __version__
from translate_toolkit.misc.dictutils import cidict
...
class poheader:
    ...
    def gettargetlanguage(self):
        ...
        if lang is not None:
            from translate_toolkit.lang.data import langcode_ire
        ...
        if "X-Poedit-Language" in header:
            from translate_toolkit.lang import poedit
        ...
        if "Language-Team" in header:
            from translate_toolkit.lang.team import guess_language
