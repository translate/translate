...
if platform.python_implementation() == "CPython":
    if usecpo == "1":
        from translate_toolkit.storage.cpo import *  # pylint: disable=W0401,W0614
    elif usecpo == "2":
        from translate_toolkit.storage.fpo import *  # pylint: disable=W0401,W0614
    else:
        from translate_toolkit.storage.pypo import *  # pylint: disable=W0401,W0614
else:
    if usecpo:
        logging.error(
    ...
    from translate_toolkit.storage.pypo import *  # pylint: disable=W0401
