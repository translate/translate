...
from translate_toolkit.misc.multistring import multistring
from translate_toolkit.storage.placeables import StringElem
from translate_toolkit.storage.placeables import parse as rich_parse
from translate_toolkit.storage.workflow import StateEnum as states
...
class TranslationUnit:
    ...
    - Zero or more *errors*. Some tools (eg.
      :mod:`~translate_toolkit.filters.pofilter`) can run checks on translations and
    ...
    def rich_to_multistring(cls, elem_list):
        ...
        >>> from translate_toolkit.storage.placeables.interfaces import X
