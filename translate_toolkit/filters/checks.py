...
from translate_toolkit.filters import decoration, helpers, prefilters, spelling
from translate_toolkit.filters.decorators import cosmetic, critical, extraction, functional
from translate_toolkit.lang import data, factory
...
def runtests(str1, str2, ignorelist=()):
    ...
    from translate_toolkit.storage import base
