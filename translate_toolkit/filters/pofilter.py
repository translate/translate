...
from translate_toolkit.filters import autocorrect, checks
from translate_toolkit.misc import optrecurse
from translate_toolkit.storage import factory
from translate_toolkit.storage.poheader import poheader
...
def cmdlineparser():
    ...
    parser.add_option(
        ...
        dest="targetlanguage",
        default=None,
        help="set target language code (e.g. af-ZA) [required for spell check and recommended in general]",
        metavar="LANG",
    )
    parser.add_option(
        "",
    ...
    parser.add_option(
        ...
        action="store_const",
        default=None,
        const=checks.LibreOfficeChecker,
