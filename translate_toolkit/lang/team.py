...
LANG_TEAM_CONTACT_SNIPPETS = {
    ...
    "be": (
        "i18n@mova.org",
        "i18n@tut.by",
        "mozilla_byx@poczta.fm",
    ),
    "be@latin": (
        "translation-team-be-latin@lists",
        "be-latin.open-tran.eu",
    ),
    "bg": (
        "dict@fsa-bg.org",
    ...
    "bn": (
        "gnome-translation@bengalinux.org",
        "core@bengalinux.org",
    ...
    "br": (
        ...
        "brenux@free.fr",
        "tradgnome@softcatala.net",
        "fedora@softcatala.org",
    ),
    "bs": (
        "lokal@linux.org.ba",
        "lokal@lugbih.org",
    ...
    "cs": (
        ...
        "kde-czech-apps@lists.sf.net",
        "translations.cs@gnupg.cz",
    ),
    "cy": (
        "gnome-cy@lists.linux.org.uk",
        "gnome-cy@pengwyn.linux.org.uk",
        "gnome-cy@www.linux.org",
    ...
    "en@shaw": (
        "ubuntu-l10n-en-shaw@launchpad.net",
        "ubuntu-l10n-en-shaw@lists.launchpad.net",
    ),
    "eo": (
        "eo-tradukado@lists.tuxfamily.org",
    ...
    "et": (
        "gnome-et@linux.ee",
        "kde-et@linux.ee",
        "linux-ee@lists.eenet.ee",
        "linux-et@lists.eenet.ee",
        "et-gnome@linux.ee",
        "linux-ee@eenet.ee",
    ),
    "eu": (
        "debian-l10n-basque@lists.debian.org",
        "debian-l10n-eu@lists.debian.org",
        "itzulpena@euskalgnu.org",
        "gnome@euskalgnu.org",
        "librezale@librezale.org",
        "linux-eu@chanae.alphanet.ch",
    ),
    "fa": (
        "farsi@lists.sharif.edu",
        "Farsiweb.info",
    ),
    "fi": (
        "debian-l10n-finnish@lists.debian.org",
        "gnome-fi-laatu@lists.sourceforge.net",
        "laatu@lokalisointi.org",
        "lokalisointi-laatu@linux-aktivaattori.org",
        "laatu@gnome.fi",
    ...
    "fr": (
        ...
        "traduc@traduc.org",
        "pgsql-fr-generale@postgresql.org",
        "rpm-fr@livna.org",
    ),
    "ga": (
        "gaeilge-gnulinux@lists.sourceforge.net",
        "gaeilge-a@listserv.heanet.ie",
    ),
    "gl": (
        "trasno@ceu.fi.udc.es",
        "gnome@g11n.net",
        "gpul-traduccion@ceu.fi.udc.es",
        "proxecto@trasno.net",
        "trasno@gpul.org",
    ),
    ...
    "he": (
        ...
        "fedora-he-list@redhat.com",
        "mdk-hebrew@iglu.org.il",
    ),
    "hi": (
        "indlinux-hindi-gnome@lists.sourceforge.net",
    ...
    "ja": (
        ...
        "translation@gnome.gr.jp",
        "jpug-doc@ml.postgresql.jp",
    ),
    "ka": (
        "geognome@googlegroups.com",
    ...
    "ko": (
        "gnome-kr-hackers@list.kldp.net",
        "gnome-kr-hackers@lists.kldp.net",
        "gnome-kr-translation@lists.kldp.net",
    ...
    "ky": (
        "i18n-team-ky-kyrgyz@lists.sourceforge.net",
        "ky-li@mail.ru",
    ),
    "la": ("gnome-latin-list@gnome.org",),
    "li": ("li@gnome.org",),
    "lt": (
        "gimp-lt@lists.akl.lt",
        "gnome-lt@lists.akl.lt",
        "gnome-lt@lists.gnome.org",
        "komp_lt@konferencijos.lt",
    ),
    "lv": (
        "lata-l10n@googlegroups.com",
        "lata-i18n@groups.google.com",
        "locale@laka.lv",
        "ll10nt@os.lv",
    ),
    "mai": ("maithili.sf.net",),
    ...
    "mk": (
        "gnomk-main@lists.sourceforge.net",
        "lug@lists.linux.net.mk",
    ...
    "ms": (
        "gabai-penyumbang@lists.sourceforge.net",
        "gabai-penyumbang@lists.sf.net",
        "kedidiemas@yahoogroups.com",
    ),
    ...
    "or": (
        ...
        "oriya-it@googlegroups.com",
    ),
    "pa": (
        "punjabi-l10n@users.sf.net",
        "fedora-pa-list@redhat.com",
        "punjabi-users@lists.sf.net",
        "punjabi-l10n@lists.sourceforge.net",
    ...
    "pt_BR": (
        ...
        "fedora-docs-br@redhat.com",
        "fedora-trans-pt-br@redhat.com",
    ...
    "ro": (
        ...
        "gnomero-list@lists.sourceforge.net",
        "debian-l10n-romanian@lists.debian.org",
    ),
    "ru": (
        "pgsql-rus@yahoogroups.com",
        "debian-l10n-russian@lists.debian.org",
        "gnupg-ru@gnupg.org",
    ),
    "scn": ("l10n@cademiasiciliana.org",),
    "sk": (
    ...
    "sq": (
        "gnome-albanian-perkthyesit@lists.sourceforge.net",
        "debian-l10n-albanian@lists.debian.org",
    ),
    "sr": (
        "@prevod.org",
        "serbiangnome-lista@nongnu.org",
    ),
    "sv": (
    ...
    "ta": (
        "gnome-tamil-translation@googlegroups.com",
        "tamilinix@yahoogroups.com",
        "Ubuntu-l10n-tam@lists.ubuntu.com",
        "tamil-DI@yahoogroups.com",
    ),
    "te": (
        "localisation@swecha.org",
        "indlinux-telugu@lists.sourceforge.net",
    ),
    "th": (
        "l10n@opentle.org",
        "thai-l10n@googlegroup.com",
        "thailang@buraphalinux.org",
    ...
    "wa": ("linux-wa@",),
    "xh": (
        "xh-translate@ubuntu.com",
        "xhosa@translate.org.za",
        "xhosa@ubuntu.com",
    ),
    "zh_CN": (
...
def guess_language(team_string):
    ...
    if not lang:
        # print ("MISSED: '%s'" % team_string).encode('utf-8')
        return None
    return lang
...
if __name__ == "__main__":
    ...
    from translate_toolkit.storage import factory
