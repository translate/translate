...
See: https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/asciidoc2po.html
...
class PO2AsciiDocOptionParser(convert.ConvertOptionParser):
    ...
    def recursiveprocess_by_templates(self, options):
        ...
        iterates through all template files and applies the relevant translations to each.
        """
