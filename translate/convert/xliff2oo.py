...
def main(argv=None):
    ...
    parser.add_argument(
        "--nonrecursiveoutput", dest="allowrecursiveoutput",
        default=True, action="store_false",
        help="don't treat the output oo as a recursive store")
    parser.add_argument(
        "--nonrecursivetemplate",
        dest="allowrecursivetemplate", default=True, action="store_false",
        help="don't treat the template oo as a recursive store")
    parser.add_argument(
        "--skipsource", dest="skip_source", default=False, action="store_true",
        help="don't output the source language, but fallback to it where needed")
    parser.add_argument(
        "--filteraction", dest="filteraction", default="none", metavar="ACTION",
