...
class html2po:
    ...
    def convertfile(self, inputfile, filename, duplicatestyle="msgctxt",
        ...
        self.convertfile_inner(inputfile, outputstore, keepcomments)
...
class Html2POOptionParser(convert.ConvertOptionParser):
    ...
    def __init__(self):
        formats = {
            "html": ("po", self.converthtml),
            "htm": ("po", self.converthtml),
            "xhtml": ("po", self.converthtml),
            None: ("po", self.converthtml),
        }
        super().__init__(formats, usetemplates=False, usepots=True,
                         description=__doc__)
        self.add_option("--keepcomments", dest="keepcomments", default=False,
                        action="store_true",
    ...
    def converthtml(self, inputfile, outputfile, templates, pot=False,
                    duplicatestyle="msgctxt", multifilestyle="single", keepcomments=False):
