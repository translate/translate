...
class TestHTML2POCommand(test_convert.TestConvertCommand, TestHTML2PO):
    ...
    def test_multifile_single(self):
        ...
        self.create_testfile("file1.html", '<div>You are only coming through in waves</div>')
        self.create_testfile("file2.html", '<div>Your lips move but I cannot hear what you say</div>')
