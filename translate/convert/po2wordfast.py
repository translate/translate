...
"""Converts Gettext .po files to a Wordfast translation memory file"""
...
def main(argv=None):
  ...
  parser = WfOptionParser(formats, usepots=True, usetemplates=False, description=__doc__, archiveformats=archiveformats)
