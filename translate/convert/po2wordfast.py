...
See: https://docs.translatehouse.org/projects/translate-toolkit/en/latest/commands/po2wordfast.html
...
class po2wordfast:
    @staticmethod
    def convertfiles(
        inputfile, wffile, sourcelanguage="en", targetlanguage=None
    ) -> None:
