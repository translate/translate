...
def test_unescape():
    ...
    assert trados.unescape("Association for Road Safety \\endash  Conference") == "Association for Road Safety –  Conference"


def test_escape():
    # NBSP
    assert trados.escape("Ordre du jour\u00a0:") == "Ordre du jour\\~:"
    assert trados.escape("Association for Road Safety –  Conference") == "Association for Road Safety \\endash  Conference"
