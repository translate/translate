...
class FilterOptionParser(optrecurse.RecursiveOptionParser):
    ...
    def __init__(self, formats):
        ...
        self.add_argument("-l", "--listfilters", action="store_true", dest='listfilters',
            default=False,
