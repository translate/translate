...
LANG_TEAM_REGEX = (
   ...
   ("translate-discuss", "translate-discuss-([a-z_A-Z]+)@lists.sourceforge.net", None),
...
"""Data for regular expression based extraction.  The fieds are: prefilter information,
regex with single group that contains the language code, postfilter."""
...
LANG_TEAM_CONTACT_SNIPPETS = {
    ...
    "ast": ("@softastur.org", "launchpad.net/~ubuntu-l10n-ast", "softast-xeneral@lists.sourceforge.net", "Softastur",),
    ...
    "bn": ("gnome-translation@bengalinux.org", "core@bengalinux.org", "ankur-bd-l10n@googlegroups.com", "redhat-translation@bengalinux.org", ),
    "bn_IN": ("anubad@lists.ankur.org.in", ),
    "br": ("drouizig@drouizig.org", "brenux@free.fr", "tradgnome@softcatala.net", "fedora@softcatala.org", ),
    ...
    "el": ("debian-l10n-greek@lists.debian.org", "i18ngr@lists.hellug.gr", "i18n@hellug.gr", "nls@tux.hellug.gr", "team@gnome.gr", "team@lists.gnome.gr", "users@el.openoffice.org", ),
    "en_AU": ("trans@six-by-nine.com.au", ),
    "en_CA": ("adamw@gnome.org", "adamw@freebsd.org", ),
    "en_GB": ("kde-en-gb@kde.me.uk", ),
    "en@shaw": ("ubuntu-l10n-en-shaw@launchpad.net", "ubuntu-l10n-en-shaw@lists.launchpad.net", ),
    "eo": ("eo-tradukado@lists.tuxfamily.org", "debian-l10n-esperanto@lists.debian.org", "ubuntu-l10n-eo@lists.launchpad.net", "eo-tradukado.tuxfamily.org", ),
    "es": ("pgsql-es-ayuda@postgresql.org", "debian-l10n-spanish@lists.debian.org", "gnome-es@gnome.org", "traductores@es.gnome.org", ),
    ...
    "he": ("debian-hebrew-common@lists.alioth.debian.org", "kde-il@yahoogroups.com", "fedora-he-list@redhat.com", "mdk-hebrew@iglu.org.il", ),
    ...
    "ja": ("debian-doc@debian.or.jp", "debian-japanese@lists.debian.org", "gnome-translation@gnome.gr.jp", "translation@gnome.gr.jp", "jpug-doc@ml.postgresql.jp", ),
    "ka": ("geognome@googlegroups.com", "Ubuntu-Georgian-Translators@googlegroups.com", ),
    ...
    "li": ("li@gnome.org", ),
    "lt": ("gimp-lt@lists.akl.lt", "gnome-lt@lists.akl.lt", "gnome-lt@lists.gnome.org", "komp_lt@konferencijos.lt", ),
    "lv": ("lata-l10n@googlegroups.com", "lata-i18n@groups.google.com", "locale@laka.lv", "ll10nt@os.lv", ),
    "mai": ("maithili.sf.net", ),
    "mg": ("i18n-malagasy-gnome@gnome.org", ),
    "mi": ("maori@nzlinux.org.nz", ),
    "mk": ("gnomk-main@lists.sourceforge.net", "lug@lists.linux.net.mk", "mkde-l10n@lists.sourceforge.net", "ossm-members@hedona.on.net.mk", ),
    "ml": ("smc-discuss@googlegroups.com", ),
    "mn": ("openmn-", "openmn.org", ),
    "ms": ("gabai-penyumbang@lists.sourceforge.net", "gabai-penyumbang@lists.sf.net", "kedidiemas@yahoogroups.com", ),
    "nb": ("i18n-nb@lister.ping.uio.no", ),
    "nds": ("nds-lowgerman@lists.sourceforge.net", ),
    "ne": ("info@mpp.org.np", ),
    "nl": ("debian-l10n-dutch@lists.debian.org", "vertaling@nl.gnome.org", "vertaling@vrijschrift.org", "nl@vrijschrift.org", "vertaling@nl.linux.org", "vertaling@nl.li.org", ),
    "nn": ("i18n-nn@lister.ping.uio.no", ),
    "nso": ("sepedi@translate.org.za", ),
    "or": ("oriya-group@lists.sarovar.org", "oriya-it@googlegroups.com", ),
    "pa": ("punjabi-l10n@users.sf.net", "fedora-pa-list@redhat.com", "punjabi-users@lists.sf.net", "punjabi-l10n@lists.sourceforge.net", "punlinux-i18n@lists.sourceforge.net", ),
    ...
    "sq": ("gnome-albanian-perkthyesit@lists.sourceforge.net", "debian-l10n-albanian@lists.debian.org", ),
    "sr": ("@prevod.org", "serbiangnome-lista@nongnu.org", ),
    "sv": ("debian-l10n-swedish@lists.debian.org", "tp-sv@listor.tp-sv.se", ),
    "ta": ("gnome-tamil-translation@googlegroups.com", "tamilinix@yahoogroups.com", "Ubuntu-l10n-tam@lists.ubuntu.com", "tamil-DI@yahoogroups.com", ),
    "te": ("localisation@swecha.org", "indlinux-telugu@lists.sourceforge.net", ),
    "th": ("l10n@opentle.org", "thai-l10n@googlegroup.com", "thailang@buraphalinux.org", "thai-l10n@googlegroups.com", "l10n.opentle.org", ),
    "tk": ("kakilikgroup@yahoo.com", ),
    "tl": ("debian-tl@banwa.upm.edu.ph", ),
    "tr": ("debian-l10n-turkish@lists.debian.org", "gnome-turk@gnome.org", "gnu-tr-u12a@lists.sourceforge.net", "turkce@pardus.org.tr", ),
    ...
    "wa": ("linux-wa@", ),
    "xh": ("xh-translate@ubuntu.com", "xhosa@translate.org.za", "xhosa@ubuntu.com", ),
    "zh_CN": ("i18n-translation@lists.linux.net.cn", "i18n-zh@googlegroups.com", "translation-team-zh-cn@lists.sourceforge.net", "i18n-zh@googlegroup.com", ),
    "zh_TW": ("zh-l10n@lists.linux.org.tw", "chinese-l10n@googlegroups.com", "community@linuxhall.org", "zh-l10n@linux.org.tw", ),
...
LANG_TEAM_LANGUAGE_SNIPPETS = {
    ...
    "my": ("Burmese", ),
    "nb": ("Norwegian Bokmaal", u"Norsk bokmål", u"Norwegian Bokmål", u"Norwegian bokmål", ),
    "nds": ("Low Saxon", ),
    "nl": ("Dutch", "Nederlands", ),
    ...
    "pl": ("Polish", ),
    "ps": ("Pashto", "Pushto", ),
    "pt_BR": ("Brazilian Portuguese", u"Português/Brasil", u"Português do Brasil", ),
    "pt": ("Portuguese", ),
    "rm": ("Rhaeto-Romance", ),
    ...
    "yi": ("Yiddish", ),
    "yo": ("Yoruba", ),
    "zh_CN": ("Chinese Simplified", "Chinese/Simplified", "Chinese (simplified)", "Simplified Chinese", ),
    "zh_HK": ("Chinese (Hong Kong)", ),
    "zh_TW": ("Chinese (traditional)", "Chinese/Traditional", "Traditional Chinese", ),
}
...
def guess_language(team_string):
    ...
    if not lang:
        lang = _snippet_guesser(LANG_TEAM_CONTACT_SNIPPETS, team_string, _lower)
