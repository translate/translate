...
languages = {
    ...
    'anp': (u'Angika', 2, '(n != 1)', []),
    'ar': (u'Arabic', 6,
           'n==0 ? 0 : n==1 ? 1 : n==2 ? 2 : n%100>=3 && n%100<=10 ? 3 : n%100>=11 ? 4 : 5', ['zero', 'one', 'two', 'few', 'many', 'other']),
    ...
    'it': (u'Italian', 2, '(n != 1)', []),
    'ja': (u'Japanese', 1, '0', ['other']),
    'jbo': (u'Lojban', 1, '0', []),
    'jv': (u'Javanese', 2, '(n != 1)', ['other']),
    'ka': (u'Georgian', 1, '0', []),
    'kk': (u'Kazakh', 1, '0', []),
