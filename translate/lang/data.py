...
# A map of plural cases supported by each language. [zero], [one] and
# [two] cases are always used by Gaia, and prop2po duplicates them as
# separate units, so we set it to False if the separate unit can be
# used (i.e. the plural rule them just for 0, 1 or 2) and the
# translation of that case in the plural unit can be ignore.
gaia_plural_cases = {
    "af":  [("one", False), ("other", True)],
    "ak":  [("one", True), ("other", True)],
    "am":  [("one", True), ("other", True)],
    "ar":  [("zero", False), ("one", False), ("two", False), ("few", True), ("many", True), ("other", True)],
    "asa": [("one", False), ("other", True)],
    "ast": [("one", False), ("other", True)],
    "az":  [("one", False), ("other", True)],
    "be":  [("one", True), ("few", True), ("many", True), ("other", True)],
    "bem": [("one", False), ("other", True)],
    "bez": [("one", False), ("other", True)],
    "bg":  [("one", False), ("other", True)],
    "bh":  [("one", True), ("other", True)],
    "bm":  [("other", True)],
    "bn":  [("one", True), ("other", True)],
    "bo":  [("other", True)],
    "br":  [("one", True), ("two", True), ("few", True), ("many", True), ("other", True)],
    "brx": [("one", False), ("other", True)],
    "bs":  [("one", True), ("few", True), ("other", True)],
    "ca":  [("one", False), ("other", True)],
    "cgg": [("one", False), ("other", True)],
    "chr": [("one", False), ("other", True)],
    "ckb": [("one", False), ("other", True)],
    "cs":  [("one", False), ("few", True), ("many", True), ("other", True)],
    "cy":  [("zero", False), ("one", False), ("two", False), ("few", True), ("many", True), ("other", True)],
    "da":  [("one", True), ("other", True)],
    "de":  [("one", False), ("other", True)],
    "dv":  [("one", False), ("other", True)],
    "dz":  [("other", True)],
    "ee":  [("one", False), ("other", True)],
    "el":  [("one", False), ("other", True)],
    "en":  [("one", False), ("other", True)],
    "eo":  [("one", False), ("other", True)],
    "es":  [("one", False), ("other", True)],
    "et":  [("one", False), ("other", True)],
    "eu":  [("one", False), ("other", True)],
    "fa":  [("one", True), ("other", True)],
    "ff":  [("one", True), ("other", True)],
    "fi":  [("one", False), ("other", True)],
    "fil": [("one", True), ("other", True)],
    "fo":  [("one", False), ("other", True)],
    "fr":  [("one", True), ("other", True)],
    "fur": [("one", False), ("other", True)],
    "fy":  [("one", False), ("other", True)],
    "ga":  [("one", False), ("two", False), ("few", True), ("many", True), ("other", True)],
    "gd":  [("one", False), ("two", False), ("few", True), ("other", True)],
    "gl":  [("one", False), ("other", True)],
    "gsw": [("one", False), ("other", True)],
    "gu":  [("one", True), ("other", True)],
    "guw": [("one", True), ("other", True)],
    "gv":  [("one", True), ("two", True), ("few", True), ("many", True), ("other", True)],
    "ha":  [("one", False), ("other", True)],
    "haw": [("one", False), ("other", True)],
    "he":  [("one", False), ("two", False), ("many", True), ("other", True)],
    "hi":  [("one", True), ("other", True)],
    "hr":  [("one", True), ("few", True), ("other", True)],
    "hu":  [("one", False), ("other", True)],
    "hy":  [("one", True), ("other", True)],
    "id":  [("other", True)],
    "ig":  [("other", True)],
    "ii":  [("other", True)],
    "in":  [("other", True)],
    "is":  [("one", True), ("other", True)],
    "it":  [("one", False), ("other", True)],
    "iu":  [("one", False), ("two", False), ("other", True)],
    "iw":  [("one", False), ("two", False), ("many", True), ("other", True)],
    "ja":  [("other", True)],
    "jbo": [("other", True)],
    "jgo": [("one", False), ("other", True)],
    "ji":  [("one", False), ("other", True)],
    "jmc": [("one", False), ("other", True)],
    "jv":  [("other", True)],
    "jw":  [("other", True)],
    "ka":  [("one", False), ("other", True)],
    "kab": [("one", True), ("other", True)],
    "kaj": [("one", False), ("other", True)],
    "kcg": [("one", False), ("other", True)],
    "kde": [("other", True)],
    "kea": [("other", True)],
    "kk":  [("one", False), ("other", True)],
    "kkj": [("one", False), ("other", True)],
    "kl":  [("one", False), ("other", True)],
    "km":  [("other", True)],
    "kn":  [("one", True), ("other", True)],
    "ko":  [("other", True)],
    "ks":  [("one", False), ("other", True)],
    "ksb": [("one", False), ("other", True)],
    "ksh": [("zero", False), ("one", False), ("other", True)],
    "ku":  [("one", False), ("other", True)],
    "kw":  [("one", False), ("two", False), ("other", True)],
    "ky":  [("one", False), ("other", True)],
    "lag": [("zero", False), ("one", False), ("other", True)],
    "lb":  [("one", False), ("other", True)],
    "lg":  [("one", False), ("other", True)],
    "lkt": [("other", True)],
    "ln":  [("one", True), ("other", True)],
    "lo":  [("other", True)],
    "lt":  [("one", True), ("few", True), ("many", True), ("other", True)],
    "lv":  [("zero", True), ("one", True), ("other", True)],
    "mas": [("one", False), ("other", True)],
    "mg":  [("one", True), ("other", True)],
    "mgo": [("one", False), ("other", True)],
    "mk":  [("one", True), ("other", True)],
    "ml":  [("one", False), ("other", True)],
    "mn":  [("one", False), ("other", True)],
    "mo":  [("one", False), ("few", True), ("other", True)],
    "mr":  [("one", True), ("other", True)],
    "ms":  [("other", True)],
    "mt":  [("one", False), ("few", True), ("many", True), ("other", True)],
    "my":  [("other", True)],
    "nah": [("one", False), ("other", True)],
    "naq": [("one", False), ("two", False), ("other", True)],
    "nb":  [("one", False), ("other", True)],
    "nd":  [("one", False), ("other", True)],
    "ne":  [("one", False), ("other", True)],
    "nl":  [("one", False), ("other", True)],
    "nn":  [("one", False), ("other", True)],
    "nnh": [("one", False), ("other", True)],
    "no":  [("one", False), ("other", True)],
    "nqo": [("other", True)],
    "nr":  [("one", False), ("other", True)],
    "nso": [("one", True), ("other", True)],
    "ny":  [("one", False), ("other", True)],
    "nyn": [("one", False), ("other", True)],
    "om":  [("one", False), ("other", True)],
    "or":  [("one", False), ("other", True)],
    "os":  [("one", False), ("other", True)],
    "pa":  [("one", True), ("other", True)],
    "pap": [("one", False), ("other", True)],
    "pl":  [("one", False), ("few", True), ("many", True), ("other", True)],
    "prg": [("zero", True), ("one", True), ("other", True)],
    "ps":  [("one", False), ("other", True)],
    "pt":  [("one", False), ("other", True)],
    "rm":  [("one", False), ("other", True)],
    "ro":  [("one", False), ("few", True), ("other", True)],
    "rof": [("one", False), ("other", True)],
    "ru":  [("one", True), ("few", True), ("many", True), ("other", True)],
    "rwk": [("one", False), ("other", True)],
    "sah": [("other", True)],
    "saq": [("one", False), ("other", True)],
    "se":  [("one", False), ("two", False), ("other", True)],
    "seh": [("one", False), ("other", True)],
    "ses": [("other", True)],
    "sg":  [("other", True)],
    "sh":  [("one", True), ("few", True), ("other", True)],
    "shi": [("one", True), ("few", True), ("other", True)],
    "sk":  [("one", False), ("few", True), ("many", True), ("other", True)],
    "sl":  [("one", True), ("two", True), ("few", True), ("other", True)],
    "sma": [("one", False), ("two", False), ("other", True)],
    "smi": [("one", False), ("two", False), ("other", True)],
    "smj": [("one", False), ("two", False), ("other", True)],
    "smn": [("one", False), ("two", False), ("other", True)],
    "sms": [("one", False), ("two", False), ("other", True)],
    "sn":  [("one", False), ("other", True)],
    "so":  [("one", False), ("other", True)],
    "sq":  [("one", False), ("other", True)],
    "sr":  [("one", True), ("few", True), ("other", True)],
    "ss":  [("one", False), ("other", True)],
    "ssy": [("one", False), ("other", True)],
    "st":  [("one", False), ("other", True)],
    "sv":  [("one", False), ("other", True)],
    "sw":  [("one", False), ("other", True)],
    "syr": [("one", False), ("other", True)],
    "ta":  [("one", False), ("other", True)],
    "te":  [("one", False), ("other", True)],
    "teo": [("one", False), ("other", True)],
    "th":  [("other", True)],
    "ti":  [("one", True), ("other", True)],
    "tig": [("one", False), ("other", True)],
    "tk":  [("one", False), ("other", True)],
    "tl":  [("one", True), ("other", True)],
    "tn":  [("one", False), ("other", True)],
    "to":  [("other", True)],
    "tr":  [("one", False), ("other", True)],
    "ts":  [("one", False), ("other", True)],
    "tzm": [("one", True), ("other", True)],
    "ug":  [("one", False), ("other", True)],
    "uk":  [("one", True), ("few", True), ("many", True), ("other", True)],
    "ur":  [("one", False), ("other", True)],
    "uz":  [("one", False), ("other", True)],
    "ve":  [("one", False), ("other", True)],
    "vi":  [("other", True)],
    "vo":  [("one", False), ("other", True)],
    "vun": [("one", False), ("other", True)],
    "wa":  [("one", True), ("other", True)],
    "wae": [("one", False), ("other", True)],
    "wo":  [("other", True)],
    "xh":  [("one", False), ("other", True)],
    "xog": [("one", False), ("other", True)],
    "yi":  [("one", False), ("other", True)],
    "yo":  [("other", True)],
    "zh":  [("other", True)],
    "zu":  [("one", True), ("other", True)],
}
