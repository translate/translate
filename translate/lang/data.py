...
# SPDX-FileCopyrightText: Michal Čihař
...
# Default-country language codes, vendored from Weblate language-data.
# Copyright © Michal Čihař; licensed under GPL-3.0-or-later.
# Refresh by copying DEFAULT_LANGS from weblate_language_data/countries.py:
# https://github.com/WeblateOrg/language-data
