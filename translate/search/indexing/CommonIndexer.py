...
class CommonDatabase(object):
    ...
    def make_query(self, args, require_all=True, analyzer=None):
        ...
        for query in args:
            ...
            elif isinstance(query, six.string_type):
                if analyzer is None:
    ...
    def index_document(self, data):
        ...
        for dataset in data:
            if isinstance(dataset, tuple):
                ...
                if key is None:
                    if isinstance(value, list):
                        terms = value[:]
                    elif isinstance(value, six.string_type):
                        terms = [value]
                    else:
            ...
            elif isinstance(dataset, six.string_type):
    ...
    def set_field_analyzers(self, field_analyzers):
        ...
        for field, analyzer in field_analyzers.items():
            ...
            if not isinstance(field, (six.string_type, six.text_type)):
    ...
    def get_field_analyzers(self, fieldnames=None):
        ...
        if isinstance(fieldnames, (six.string_types, six.text_type)):
