...
class TestTerminology:
    ...
    def test_brackets(self):
        ...
        # Let's make sure that even long things work if the context marker
        # might push us over some length limits
        assert termmatcher.similarity("Contact your Internet Service Provider ", \
                "Internet Service Provider (Internet Service Provider or ISP, as in the place that hooks you up)") > 75
